...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_HIMETRIC', 'FontEvents', 'FONTSTRIKETHROUGH',
           'OLE_YSIZE_CONTAINER', 'FONTBOLD', 'IPictureDisp',
           'Default', 'OLE_XPOS_PIXELS', 'OLE_YSIZE_HIMETRIC',
           'Unchecked', 'LoadPictureConstants', 'FONTUNDERSCORE',
           'OLE_CANCELBOOL', 'VgaColor', 'OLE_COLOR',
           'OLE_YPOS_CONTAINER', 'OLE_YSIZE_PIXELS', 'IFontDisp',
           'StdPicture', 'StdFont', 'FONTSIZE', 'Checked',
           'OLE_XPOS_HIMETRIC', 'Color', 'Picture', 'Font',
           'OLE_HANDLE', 'OLE_YPOS_HIMETRIC', 'OLE_YPOS_PIXELS',
           'Gray', 'Monochrome', 'OLE_XSIZE_PIXELS', 'OLE_TRISTATE',
           'IPicture', 'OLE_XPOS_CONTAINER', 'OLE_OPTEXCLUSIVE',
           'OLE_ENABLEDEFAULTBOOL', 'FONTNAME', 'OLE_XSIZE_CONTAINER',
           'IFontEventsDisp', 'IFont', 'FONTITALIC']
